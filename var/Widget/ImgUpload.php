 ...
 * @package Widget
 */
class Widget_ImgUpload extends Widget_Abstract_Contents implements Widget_Interface_Do
{
    //上传文件目录
    ...
    public static function uploadHandle($file)
    {
        ...
        $result = Typecho_Plugin::factory('Widget_ImgUpload')->trigger($hasUploaded)->uploadHandle($file);
        if ($hasUploaded) {
            return $result;
        }
    ...
    public static function modifyHandle($content, $file)
    {
        ...
        $result = Typecho_Plugin::factory('Widget_ImgUpload')->trigger($hasModified)->modifyHandle($content, $file);
        if ($hasModified) {
            return $result;
        }
    ...
    {
        $result = Typecho_Plugin::factory('Widget_ImgUpload')->trigger($hasDeleted)->deleteHandle($content);
        if ($hasDeleted) {
            return $result;
        }
    ...
    {
        $result = Typecho_Plugin::factory('Widget_ImgUpload')->trigger($hasPlugged)->attachmentHandle($content);
        if ($hasPlugged) {
            return $result;
        }
    ...
    {
        $result = Typecho_Plugin::factory('Widget_ImgUpload')->trigger($hasPlugged)->attachmentDataHandle($content);
        if ($hasPlugged) {
            return $result;
        }
